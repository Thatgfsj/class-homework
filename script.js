...
,
    ...
    },
    {
      ...
      description: "【作业要求理解】\n\n老师想让你做的是：写一份**模拟面试的自我介绍脚本**，按给定的框架组织内容，并在课堂上练习表达。\n\n核心训练三个能力：\n1. 🗣️ **发音训练** — 名字要字字清晰，重音落在最后一个字\n2. 🏷️ **职业标签** — 用一句话定义自己的职业身份\n3. 📋 **结构化表达** — 按「开场→能力→成果→动机」四段式组织\n\n---\n\n【框架原文】\n\n**第一步：发音**\n\"非常荣幸能够参加贵司的面试，我是XX！\"\n注意：名字发音要字字清晰，重音放在最后一个字。\n\n**第二步：一句话职业标签**\n用一句话给自己定位，例如：\n- 一位在软件开发领域从业6年的.net开发工程师\n- 一位在零售行业从事8年市场运营的工作者\n- 来自xx大学xx专业应届毕业生\n- 等等……\n\n**第三步：四段式自我介绍框架**\n\n1️⃣ 简短开场\n\"面试官好，我是**，9年数字营销专家，现任某科技公司增长业务负责人。\"\n✅ 礼貌问候 + 姓名 + 工作年限 + 当前职位\n\n2️⃣ 职业主线\n\"早期专注SEO与私域运营，后主导搭建跨境独立站体系\"\n✅ 核心能力：用2-3个关键词概括核心竞争力（与岗位JD强相关）\n✅ 职业路径：按时间顺序简述跳槽/晋升逻辑，突出与应聘岗位相关的经历\n\n3️⃣ 重点成果\n\"近三年操盘3个千万级用户增长项目，其中2025年DTC品牌本土化项目实现单月GMV环比增长217%。\"\n✅ 数据化成果：选择1-2个与应聘岗位最相关的项目，用数据量化价值\n\n4️⃣ 动机衔接\n\"深入研究贵司的东南亚市场战略，我的跨文化运营经验与供应链数字化改造能力，能有效支持区域市场从0到1的突破。\"\n✅ 说明为何选择该公司/岗位，体现对行业和岗位的深度理解\n\n---\n\n【注意事项】\n- 上面的例子是针对有工作经验的人设计的\n- 作为应届生，可以把\"工作年限\"替换为\"专业背景\"，把\"工作成果\"替换为\"实习/项目/学术成果\"\n- 建议根据自己应聘的具体岗位调整数据案例\n- 整体框架保持不动，只替换内容\n- 可以补充某行业特定话术\n\n提交方式：课前口头展示或按老师要求提交文本。",
