const homeworkData = {
  homeworks: [
    ...
    },
    {
      ...
      subject: "普通作业",
      title: "中学语文课程标准教学设计",
      description: "任选一篇中学语文课文，写一份完整的教学设计。\n\n教学设计须包含：\n1. 教学目标\n2. 教学重难点\n3. 教学方法\n4. 教学过程\n5. 板书设计\n\n重要要求：\n在教学目标、教学重难点等部分，需要标注每一个具体课标的来处，即引用《义务教育语文课程标准》或《普通高中语文课程标准》中的原文，并说明出自哪个层面（课程目标/学段目标/内容要求/学业质量等）。\n\n格式要求：\n- 文中涉及课标引用的地方用【课标原文】标注\n- 末尾附上所引用的课标出处（课程标准名称、页码）\n- 截止时间：下周五（5月29日）\n- 提交方式：稿纸手写，自己保留电子版PDF",
    ...
    },
    {
      ...
      subject: "论文写作",
      title: "民间文学论文",
      description: "论文选题范围：\n1. \"她\"在民间叙事中的多重面孔：从巧女、女巫到女鬼——中国民间故事女性形象的文化分析\n2. 民间文学传承的创新策略研究\n3. 探讨民间传统对联的审美特征与文化寓意\n4. 从\"神圣叙事\"到\"文化IP\"：论神话在当代的创造性转化\n\n任选其一，按要求完成论文。",
...
,
    {
      ...
      subject: "论文写作",
      title: "大学生就业指导期末作业",
      description: "写在论文纸上，字数多一些。\n\n题目：\n一、请阐述撰写求职简历的核心原则和注意事项有哪些？（20分）\n二、简述当前大学生基层就业、自主创业的相关就业扶持政策？（20分）\n三、请阐述求职中常见的面试类型及基本职场礼仪规范？（20分）\n四、案例分析（40分）\n\n小李是某高校2026届市场营销专业应届毕业生，求职季投递了30余份简历，仅收到2家公司的面试邀请。为了增加竞争力，他在简历中将自己仅参与过1周的校园促销活动，夸大写成\"独立负责某品牌校园推广项目，带领5人团队，实现销售额2万元\"。\n面试某快消公司销售岗时，小李因睡过头迟到12分钟，穿着牛仔裤和运动鞋进入考场；回答问题时常眼神躲闪，被面试官追问项目细节时支支吾吾，最终面试失败。\n半个月后，小李入职一家小型电商公司做运营助理。入职第一周，他觉得领导安排的整理数据、核对订单等基础工作\"太简单、没技术含量\"，经常拖延任务，还在办公室抱怨\"大学学的知识根本用不上\"。一次，他对部门的活动方案有不同意见，没有先和直属领导沟通，直接发邮件向总经理提出质疑，导致直属领导非常不满。入职仅1个月，小李就因\"工作态度不端正、团队协作能力差\"被公司辞退。\n\n1. 请结合案例，分析小李在求职和初入职场全过程中存在哪些核心问题？（20分）\n2. 如果你是小李，从求职准备到入职适应，你会做出哪些针对性改进？（20分）",
    ...
    },
    {
      ...
      subject: "论文写作",
      title: "西方文论期末论文",
      description: "写在论文纸上。\n\n考试题目（二选一）：\n1. 论陌生化理论的价值。\n2. 请以西方文论中某一具体理论（如心理批评、形式主义、接受美学等）为研究方法，以文学作品或文学现象为对象，写一篇研究性论文。\n\n要求：\n1. 题目自拟，中心突出\n2. 论点清晰，层次清楚\n3. 不得抄袭\n4. 不少于1500字",
      publishDate: "2026-06-11",
      dueDate: "2026-06-22",
      status: "active"
    },
    {
      id: "hw021",
      subject: "普通作业",
      title: "比较文学 — 比较文学的危机大纲",
      description: "梳理比较文学之前课上讲的\"比较文学的危机\"相关内容，提交大纲、关键词、每段总结等。\n提交论文纸。",
      publishDate: "2026-06-11",
      dueDate: "2026-06-12",
      status: "active"
    },
    {
      ...
      subject: "论文写作",
      title: "比较文学期末论文",
      description: "提交论文纸。\n\n论文写作（二选一）：\n1. 请结合具体的外国文学中译本，从比较文学的视角，论述翻译过程中的\"得\"与\"失\"。\n2. 请选取影响研究、平行研究、跨学科研究等比较文学任一角度完成论文。\n基础参考书目：《百变小红帽：一则童话三百年的演变》（凯瑟琳·奥兰丝汀 著）\n\n要求：\n1. 题目自拟，主题始终围绕比较文学展开\n2. 结构完整：包含题目、摘要、关键词、引言、正文（分章节）、结语、参考文献\n3. 正文逻辑：论点明确，分章节逐层展开，段落衔接自然\n4. 全文总字数不少于3000字",
      publishDate: "2026-06-11",
      dueDate: "2026-06-23",
      status: "active"
    },
    {
      ...
      subject: "论文写作",
      title: "对比语言学课程论文",
      description: "一、在双语交际、对外汉语教学、跨文化传播实践中，多数语言误用、表达生硬、句式套用、句式问题，均源于对汉英语言系统差异认知模糊。请根据所学从以下选题范围中任选一个完成一篇论文：\n\n1. 汉英构词法对比分析（复合构词、派生构词的异同比较）；\n2. 汉英熟语语义特征与文化内涵对比（谚语、格言、惯用语）；\n3. 汉英祈使句对比研究。\n\n论文要求：\n\n请结合规定选题，题目自拟，完成一篇 2000 字左右的论文。具体要求如下：\n\n1. 论文应包括：题目、中文摘要、关键词、正文、参考文献。\n2. 要求论点鲜明，论据充分，理论与实际相结合。\n3. 不得抄袭，否则零分处理。",
    ...
    },
    {
      id: "hw024",
      subject: "论文写作",
      title: "《中学语文课程标准与教材研究》论文",
      description: "一、论述题（40分）\n\n教材第二章详细论述了《义务教育语文课程标准（2022年版）》提出的\"核心素养\"四个维度：文化自信、语言运用、思维能力、审美创造。同时指出，语文课程性质的界定经历了从\"工具性\"到\"工具性与人文性统一\"再到\"核心素养\"的演变过程。请结合教材中的相关论述，回答以下问题：\"语言运用\"是语文核心素养的\"基础\"，还是与其他三个维度并列的\"组成部分\"？如果脱离了\"文化自信\"\"思维能力\"\"审美创造\"来单独训练\"语言运用\"，是否还能称之为\"语文课程\"？请阐述你的观点，并说明理由。（不少于1000字）\n\n二、论述题（60分）\n\n请结合徐林祥《中学语文课程标准与教材研究》（第2版）第四章\"初中语文教材分析\"中关于\"文言诗文教材分析\"的相关论述，以及该章节所附的案例分析，请以统编初中语文教材中的某一篇文言文为例，分析该课文的\"助学系统\"（包括单元导语、预习提示、注释、课后探究与拓展题等）是如何体现课程标准理念的？你认为该助学系统存在哪些可改进之处？（要求不少于1000字）",
...
const elements = {
  ...
  mainHomeworkSection: document.getElementById('mainHomeworkSection'),
  mainHomeworkGrid: document.getElementById('mainHomeworkGrid'),
...
function renderMainHomeworkList(homeworks) {
  ...
  elements.mainHomeworkSection.style.display = 'block';
  elements.mainHomeworkGrid.innerHTML = sorted.map((hw, index) => createHomeworkCard(hw, index)).join('');
  bindCardEvents();
}
...
function renderUpcomingList(homeworks) {
  ...
  elements.upcomingSection.style.display = 'block';
  elements.upcomingGrid.innerHTML = recents.map((hw, index) => createHomeworkCard(hw, index)).join('');
  bindCardEvents();
}
...
function renderModal(homework) {
  ...
  const hasAIPrompt = homework.description.includes('AI 参考提示词') || homework.description.includes('# 角色设定');
  ...
  if (parts.length > 1) {
    ...
    const copyBtn = '<button class="copy-prompt-btn" onclick="copyAIPrompt()">复制提示词</button>';
    const promptText = parts[1].replace(/^[:：]\n?/, '').trim();
    descHTML = intro + '<div class="ai-prompt-section">' + copyBtn + '<pre class="ai-prompt-text">' + promptText + '</pre></div>';
  } else {
  ...
  elements.modalContent.innerHTML = `
    <div class="modal-header">
      ...
      <div class="modal-meta">
        <span class="modal-date">截止：${formatFullDate(homework.dueDate)} · ${getWeekday(homework.dueDate)}</span>
        ${!isExpired ? '<span class="modal-countdown ' + (countdown.urgent ? 'urgent' : '') + '">' + countdown.value + ' ' + countdown.text + '</span>' : '<span class="modal-countdown expired">已截止</span>'}
      </div>
    </div>
...
function bindCardEvents() {
  document.querySelectorAll('.homework-card').forEach(card => {
    card.addEventListener('click', () => {
      ...
      const homework = homeworkData.homeworks.find(h => h.id === id);
      if (homework) {
...
function filterHomeworks(filter = 'all', searchTerm = '') {
  let filtered = homeworkData.homeworks;
  if (filter !== 'all') {
    filtered = filtered.filter(h => h.subject === filter);
  }
  if (searchTerm) {
  ...
  renderMainHomeworkList(filtered);
...
elements.filterButtons.addEventListener('click', e => {
  if (e.target.classList.contains('filter-btn')) {
    ...
    filterHomeworks(activeFilter, activeSearch);
  }
});
...
document.addEventListener('keydown', e => {
  if (e.key === 'Escape' && elements.modalOverlay.classList.contains('visible')) closeModal();
});
